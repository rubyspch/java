...
public class Controller {
    ...
    public void initialize() {
        ...
        */
        ...
        mod1Choice.setItems(FXCollections.observableArrayList(modChoices));
        mod2Choice.setItems(FXCollections.observableArrayList(modChoices));
        mod3Choice.setItems(FXCollections.observableArrayList(modChoices));
        //Don't know what the addAll() is about??
    ...
    public void getChoice(ActionEvent event) {
         ...
         */
        // event's target's value = choice1/2/3
        if(event.getSource().equals(mod1Choice))
            ...
            System.out.print("Error with getChoice()");
    ...
    public void editStudent(Student stu) {
        ...
        try {
            ...
            /* TODO: print an appropriate message if it cannot be loaded
                     print stacktrace
             */
            System.out.println("Could not load the dialog pane"); //HAVE THEY SPECIFIED THE ERROR THEY WANT?
